    ...
    return (
        <div className="introduce-container">
            ...
            <div className="introduce-catch-box">
                <div className="introduce-catch-content">
                    <div className="introduce-catch-desc">
                        <div className="introduce-catch-title">가치 있는 포트폴리오를, 더 나은 전시회로</div>
            ...
            <div className="introduce-linkerbell-box">
                ...
                <div className="introduce-linekerbell-desc">포트레이트는 파일 업로드를 통하여 간편한 등록이 가능합니다. 여러분의 개성넘치는 포트폴리오를 업로드 해보세요.</div>
            </div>
